...
int haasClassifierTest(vector<string> fileName);
int HOGPeopleDefaultTest(vector<string> images);
...
int main(int argc, char** argv) {
	...
	int hogTest = HOGPeopleDefaultTest(fileNames);
	int haasTest = haasClassifierTest(fileNames);
	return  haasTest && hogTest ;
}
...
int haasClassifierTest(vector<string> imageFileNames) {
